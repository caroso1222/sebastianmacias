...
PageTransitions = (function() {
        ...
        function navigationPage() {
                ...
                $(document).on("click", ".page-link", function (e) {
                    ...
                    //console.log("pathname: " + location.pathname + location.hash );
                    nextPage(getAnimcursor($(this)), ahrefhash, $(this));
        ...
        function startLazy(sectionId) {

                jQuery("section" + sectionId + " img.lazy").lazy(
                    {
                        bind: "event",
                        effect: "fadeIn",
                        effectTime: 2000,
                        appendScroll: jQuery("section" + sectionId + " div.content"),
                        delay:0
                    });
        }
        ...
        function ajaxLoadPage(dane) {
                $('.page-ajax-preloader').fadeIn('200');
                ...
                .done(function (html) {               
                        ...
                        $('.page-ajax-preloader').fadeOut('200');
